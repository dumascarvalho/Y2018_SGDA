...
public final class RedimensionarJTableModel implements PropertyChangeListener, TableModelListener {
     ...
     */
    public RedimensionarJTableModel(JTable table) {
        this(table, 6);
    }
     ...
     */
    public RedimensionarJTableModel(JTable table, int spacing) {
        this.table = table;
...
//
    ...
    /*
	 *  Toggle properties of the Redimensionar_JTabela so the user can
